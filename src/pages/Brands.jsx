...
export default function Brands() {
  return (
    ...
    <div className='relative'>
        <img src='./brand.webp' className='w-full h-[760px]'/>
        <div className='absolute top-[25%] left-[25%] right-0 bottom-0 text-white'>
         <p className='text-[90px] font-[700]'>The Brands We Serve</p>
         <p className='text-[30px] mr-[400px] text-center'>Lorem ipsum dolor, sit amet consectetur adipisicing elit
      ...
      <div className=''>
        <div className='text-center mt-[200px] text-[34px]'>
      ...
      <div className='text-center mt-[200px]'>
        <p className='text-[50px] font-[100] '><span className='text-[60px] font-[700]'>The Game of Brands </span></p>
        <p className='text-[30px] font-[200] mt-10'>Lorem ipsum dolor sit amet consectetur adipisicing elit.laboriosam,<br></br>
           repudiandae quia exercitationem earum eligendi animi neque quidem. Possimus<br></br>
           Fuga eligendi ducimus ad optio laudantium quibusdam est repudiandae iste 
        </p>
        <p className='text-[30px] font-[200]'>Lorem ipsum dolor sit amet consectetur adipisicing elit.laboriosam,<br></br>
           repudiandae quia exercitationem earum eligendi animi neque quidem. Possimus
        </p>
        ...
        <p  className='text-[30px] font-[200]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro dicta,<br></br> 
          usto vel facere placeat optio nesciunt nobis itaque ut perspiciatis.<br></br>
          usto vel facere placeat optio nesciunt nobis itaque ut perspiciatis.<br></br>
