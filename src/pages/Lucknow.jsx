...
function show(route){
  ...
  return (
    ...
    <div className=''>
      ...
      <img src='https://i.ytimg.com/vi/UCcaPg9p5fQ/maxresdefault.jpg'
      ...
      <div className='absolute text-gray-400 top-[200px] right-[200px] text-end '>
        ...
        <span className='space-x-6 text-14'>for </span><span className='font-semibold'>Lucknow</span></p>
      </div>
      
    </div> 
    <div className='w-full h-full bg-black-500 text-center border-6 text-[80px] mt-[100px] mb-[50px]'>
      <p className=''>Planing to Rent</p>
      <p>a luxury Cars for <span className='font-semibold'>Lucknow ?</span></p>
      ...
      <p>Renting a luxury Cars in <span className='font-semibold'>Lucknow ?</span></p>
